...
function initExpandedCourseCatalog() {
  ...
  const courses = [
    ...
    ['devops', 'Certified AWS DevOps Course', '5 months', 'AWS lab', 'DevOps', 'Automate cloud delivery using AWS, containers, and infrastructure as code.', 'courses/devops/certified-aws-devops.html', 'assets/images/courses/official-logos/aws-devops-square.svg'],
    ['devops', 'Certified DevOps Engineer Course', '5 months', 'CI/CD lab', 'DevOps', 'Practice automation, continuous delivery, monitoring, and orchestration.', 'courses/devops/certified-devops-engineer.html', 'assets/images/courses/official-logos/devops-official.svg'],
    ...
    ['docker', 'Certified Kubernetes Security Specialist (CKS)', '10 weeks', 'Security lab', 'K8s', 'Secure Kubernetes workloads, policies, clusters, and runtime environments.', 'courses/docker-kubernetes/certified-kubernetes-security-specialist.html', 'assets/images/courses/official-logos/kubernetes-official.svg'],
    ['docker', 'Certified Kubernetes Administrator (CKA)', '10 weeks', 'Cluster lab', 'K8s', 'Administer clusters, deployments, services, and cloud-native operations.', 'courses/docker-kubernetes/certified-kubernetes-administrator.html', 'assets/images/courses/official-logos/kubernetes-official.svg'],
    ...
    ['cybersecurity', 'Advanced Penetration Testing', '4 months', 'Security lab', 'Cyber', 'Advance practical testing skills for networks, systems, and web applications.', 'courses/cybersecurity/advanced-penetration-testing.html', 'assets/images/courses/official-logos/advanced-pentest-square.svg'],
    ...
    ['dsa', 'Data Structures & Algorithms Bootcamp', '3 months', 'Coding lab', 'DSA', 'Strengthen problem solving, data structures, and interview-ready algorithms.', 'courses/dsa/data-structures-algorithms-bootcamp.html', 'assets/images/courses/official-logos/dsa-official.svg'],
    ...
    ['softskills', 'Soft Skill and Communication Training', '8 weeks', 'Live workshop', 'Skills', 'Strengthen workplace communication, presentation, and professional confidence.', 'courses/soft-skills/communication-training.html', 'assets/images/courses/official-logos/softskills-official.svg'],
    ['marketing', '360° Digital Marketing Professional Program', '4 months', 'Marketing lab', 'Marketing', 'Plan campaigns across search, content, social, email, and analytics.', 'courses/digital-marketing/digital-marketing-professional.html', 'assets/images/courses/official-logos/digital-marketing-official.svg']
  ];
